...
@mcp.tool(
    name="get_city_location_info",
    description="도시 이름을 입력하여 도시 위치정보를 반환하는 도구, 도시의 이름은 한글로 입력해야합니다.",
)
...
@mcp.tool(
    name="get_forecast",
    description="위치정보와 원하는 날짜값을 입력하면 날씨 정보를 반환해줘, 날짜는 string 타입의 1,5,10,15 만 가능하고 숫자가 아니라면 가장 가까운 숫자를 찾아서 쓰세요.",
)
